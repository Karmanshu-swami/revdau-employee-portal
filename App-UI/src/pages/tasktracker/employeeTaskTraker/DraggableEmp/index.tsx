...
const Kanban = (taskid: any) => {
  ...
  const handelDate = async () => {
    const options = {
      method: "PUT",
      body: JSON.stringify({
        submission_date: cdate,
      }),
      headers: {
        "Content-Type": "application/json",
      },
    };
    await fetch(submitdate_URL, options);
                              ...
                              <Card.Body className="p-3">
                                <Dropdown className="float-end" align="end">
                                  ...
                                  <Dropdown.Menu>
                                    ...
                                    >
                                      <i className="uil uil-edit-alt me-2"></i>
                                      Edit
                                    </Dropdown.Item>
                                    {/* <Dropdown.Item onClick={handelDate}>
                  ...
                  <div className="tasks border" ref={provided.innerRef}>
                    ...
                    >
                      <button
                        className="btn btn-link p-0 text-secondary float-end shadow-none px-0 py-2"
                        id="addNewTodo"
                        onClick={() => newTask("Pending", "inprogressTasks")}
                      >
                        <i className="uil-plus"></i>
                      </button>
                    </OverlayTrigger> */}
