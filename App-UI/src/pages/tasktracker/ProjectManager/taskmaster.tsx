...
function TaskMaster() {
  ...
  const getData = async () => {
    await fetch("http://localhost:3001/tasktracker/findAll")
  ...
  const handleTask = (id: any) => {
    navigate.push({ pathname: "/Taskallocate", state: id });
  };
  const handleView = (id: any) => {
    navigate.push({ pathname: "/taskhistorypm", state: id });
  };
      ...
      <Row>
        <Col>
          <div className="page-title-box">
            <h4 className="page-title">Teams Task Details</h4>
