...
const Kanban = () => {
    ...
    const URL = "http://localhost:3001/taskTracker/getTasks/33"
     ...
     task = await fetch(URL)
      ...
      useEffect(() => {
       ...
       const todoTasks= state.filter((t:any) => t['task_status'] === "To Do");
        const inprogressTasks = state.filter((t:any) => t['task_status'] === "in progress");
                                            ...
                                            {(provided, snapshot) => (
                                                <div
                                                    ...
                                                    <p className="mb-0 mt-4">
                                                        ...
                                                        <small className="float-end text-muted">{item['end_date']}</small>
                                                    </p>
                                                </Card.Body>
                                            </Card>
                                            {/* todo data end */}
                        ...
                        <Droppable droppableId="inprogressTasks">
                            {(provided, snapshot) => (
                                <div ref={provided.innerRef} className="tasks border">
                                    ...
                                    <h5 className="mt-0 task-header header-title">
                                        In Progress <span className="fs-13">({inprogressTasks.length})</span>
                                    </h5>
