...
const AddNewTask = ({
  ...
  // }, [location]); 
  //   const getData = async () => {       
  //    task = await fetch(("http://localhost:3001/taskTracker/addTask"))
    ...
    <Modal show={newTaskModal} onHide={toggleNewTaskModal} size="lg" centered>
      ...
      <Modal.Body>
        <form onSubmit={handleSubmit(handleNewTask)} className="px-2">
          ...
          >
            <option>-----Select-----</option>
            <option value="1">Bhuvnesh Rajput</option>
            <option value="2">Dharamveer Singh</option>
            <option value="4">Nikhil Engineer</option>
            <option value="5">Pravin Bisen</option>
          </FormInput> */}
