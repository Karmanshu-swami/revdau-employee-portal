...
const EditEmployee = () => {
    ...
    const URL = `http://localhost:3001/empMaster/update/`+id
                ...
                <Form className="form-horizontal">
                    <Row>
                            ...
                            <Form.Group as={Row} className="mb-3 mt-1.5">
                                ...
                                <Col lg={10}>
                                    <Form.Control onChange={(e:any) => onValueChange(e)} name='email' type= "text" id="simpleinput" placeholder="Enter Email" />
                                </Col>
                            </Form.Group>
                            ...
                            <Form.Group as={Row} className="mb-3 mt-1.5">
                                ...
                                <Col lg={10}>
                                    <Form.Control onChange={(e:any) => onValueChange(e)} name='password' type= "text" id="my-input" placeholder="Enter Password" />
                                </Col>
                            </Form.Group>
                            ...
                            <Form.Group as={Row} className="mb-3 mt-1.5">
                                ...
                                <Col lg={10}>
                                    <Form.Control onChange={(e:any) => onValueChange(e)} name='role' type= "text" id="simpleinput" placeholder="Enter Role" />
                                </Col>
                            </Form.Group>
                        ...
                        <Col>
                        <Button variant="success" href="/employee master" onClick={() => editUserDetails()}>Update</Button>
                        </Col>                    
                    </Row>
                </Form>
            </Card.Body>
