            ...
            <AuthLayout bottomLinks={<BottomLink />}>
                <div className="text-center">
                    <div className="auth-logo mx-auto mb-4">
                        <Link to="#" className="logo logo-sm text-center">
                    ...
                    <h4 className="h4 mb-0 mt-3">Hi ! {fname}</h4>
                    <p className="text-muted mt-1 mb-4">{t('Enter your password to access the portal.')}</p>
                </div>
                <VerticalForm<UserData>
                    ...
                    <div className="d-grid text-center">
                        <Button type="submit">{}
                        <Link to={'/auth/login'} className="text-white fw-bold ms-1">
                        {t('Log In')}
                    </Link></Button>
                    </div>
                </VerticalForm>
